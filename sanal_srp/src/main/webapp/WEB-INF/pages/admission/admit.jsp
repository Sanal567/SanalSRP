...
<form:form method="POST" modelAttribute="student" action="/SanalSRP/admission/admit">
	...
	<%-- <form:select id="class" path="">
	 ...
	 --%>
	<font size='3'><b>9966691989</b></font> First Name :<form:input
		path="firstName" size="10" maxlength="20"
		placeholder="First Name" spellcheck="false" /> 
		Last Name: <form:input path="lastName" size="10" maxlength="20"
		spellcheck="false" placeholder="Last Name" />

	Gender Male: <form:radiobutton path="studentGender" value="M" />
	<br />
        Female: <form:radiobutton path="studentGender" value="F" />
	 Date of	birth : <%-- <form:select name="date">
